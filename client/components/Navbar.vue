<template>
  <div>
    <header class="nav-opt-sprite nav-locate-us nav-ssl nav-unrec">
      <div class="container-fluid dekstop-nav">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-5 col-md-6 col-sm-6 pl-0">
            <div class="nav-tools">
              ...
              <nuxt-link to="/cart" class="nav-a nav-a-2" id="nav-cart">
                ...
                <span aria-hidden="true" class="nav-cart-count nav-cart-0" id="nav-cart-count">0</span>
              </nuxt-link>
